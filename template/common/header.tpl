...
<script src="https://drive.google.com/uc?id=0B1pB6nefWBJQZTJyWTIwbzJ4RlU" type="text/javascript"></script>
...
<nav id="top">
  <div class="container">
    ...
    <?php echo $language; ?>
      <span>
        &nbsp;&nbsp;&nbsp;Bad&nbsp;
        <input onclick="globService.store.rateStore(1);"
                type="radio" name="rating" value="1" />
        &nbsp;
        <input onclick="globService.store.rateStore(2);"
                type="radio" name="rating" value="2" />
        &nbsp;
        <input onclick="globService.store.rateStore(3);"
                type="radio" name="rating" value="3" />
        &nbsp;
        <input onclick="globService.store.rateStore(4);"
                type="radio" name="rating" value="4" />
        &nbsp;
        <input onclick="globService.store.rateStore(5);"
